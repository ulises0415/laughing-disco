    ...
    <!-- Modal content-->
        <form method="POST"  action="{{url('/carreras/'.(isset($edit_carrera->id_carrera) ? $edit_carrera->id_carrera : $edit_carrera["id_carrera"]))}}" role="form" enctype="multipart/form-data">
            <div class="modal-content">
                <input type="hidden" value="{{isset($edit_carrera->id_carrera) ? $edit_carrera->carrera : $edit_carrera["id_carrera"]}}" name="id_carrera">
                                        ...
                                        <div class="box box-info padding-1">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="carrera" value="{{isset($edit_carrera->carrera) ? $edit_carrera->carrera : $edit_carrera["carrera"]}}" class="form-control{{$errors->has('carrera') ? ' is-invalid' : ''}}" placeholder="Descripcion">
